...
func resourceIdentityRoleAssignmentV3Read(d *schema.ResourceData, meta interface{}) error {
	...
	log.Printf("[DEBUG] Retrieved SberCloud role assignment: %#v", roleAssignment)
...
// Role assignments have no ID in SberCloud. Build an ID out of the IDs that make up the role assignment
