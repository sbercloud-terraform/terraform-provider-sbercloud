...
func Provider() *schema.Provider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"sbercloud_cce_addon_template":     cce.DataSourceCCEAddonTemplateV3(),
			"sbercloud_cce_cluster":            cce.DataSourceCCEClusterV3(),
			"sbercloud_cce_clusters":           cce.DataSourceCCEClusters(),
			"sbercloud_cce_node":               cce.DataSourceCCENodeV3(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"sbercloud_cce_addon":                       cce.ResourceCCEAddonV3(),
			"sbercloud_cce_cluster":                     cce.ResourceCCEClusterV3(),
			"sbercloud_cce_namespace":                   cce.ResourceCCENamespaceV1(),
			"sbercloud_cce_node":                        cce.ResourceCCENodeV3(),
