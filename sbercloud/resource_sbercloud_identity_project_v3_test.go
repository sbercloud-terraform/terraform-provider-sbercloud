		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIdentityV3ProjectExists("sbercloud_identity_project_v3.project_1", &project),
					resource.TestCheckResourceAttrPtr(
						"sbercloud_identity_project_v3.project_1", "name", &project.Name),
					resource.TestCheckResourceAttrPtr(
						"sbercloud_identity_project_v3.project_1", "description", &project.Description),
					resource.TestCheckResourceAttr(
						"sbercloud_identity_project_v3.project_1", "domain_id", "default"),
					resource.TestCheckResourceAttr(
						"sbercloud_identity_project_v3.project_1", "enabled", "true"),
					resource.TestCheckResourceAttr(
						"sbercloud_identity_project_v3.project_1", "is_domain", "false"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"sbercloud_identity_project_v3.project_1", "domain_id", "default"),
					resource.TestCheckResourceAttr(
						"sbercloud_identity_project_v3.project_1", "enabled", "false"),
					resource.TestCheckResourceAttr(
						"sbercloud_identity_project_v3.project_1", "is_domain", "false"),
				),
			},
...
func testAccCheckIdentityV3ProjectDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "sbercloud_identity_project_v3" {
			continue
		}
