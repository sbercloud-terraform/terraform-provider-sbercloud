...
func TestAccRockemqMigrationTask_rocketmq(t *testing.T) {
	...
	resourceName := "sbercloud_dms_rocketmq_migration_task.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "instance_id", "sbercloud_dms_rocketmq_instance.test", "id"),
