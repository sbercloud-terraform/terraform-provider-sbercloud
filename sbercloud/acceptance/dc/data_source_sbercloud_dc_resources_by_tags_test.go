...
func TestAccDataSourceDcResourcesByTags_basic(t *testing.T) {
	...
	dataSource := "data.sbercloud_dc_resources_by_tags.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.sbercloud_dc_resources_by_tags.total_count_test",
						"total_count"),
...
data "sbercloud_dc_resources_by_tags" "test" {
...
data "sbercloud_dc_resources_by_tags" "matches_filter" {
  depends_on = [sbercloud_dc_virtual_gateway.test]
...
output "matches_filter_is_useful" {
  value = length(data.sbercloud_dc_resources_by_tags.matches_filter.resources) > 0
}

data "sbercloud_dc_resources_by_tags" "tags_filter" {
  depends_on = [sbercloud_dc_virtual_gateway.test]
...
output "tags_filter_is_useful" {
  value = length(data.sbercloud_dc_resources_by_tags.tags_filter.resources) > 0
}

data "sbercloud_dc_resources_by_tags" "not_tags_filter" {
  depends_on = [sbercloud_dc_virtual_gateway.test]
...
output "not_tags_filter_is_useful" {
  value = length(data.sbercloud_dc_resources_by_tags.not_tags_filter.resources) > 0
}

data "sbercloud_dc_resources_by_tags" "tags_any_filter" {
  depends_on = [sbercloud_dc_virtual_gateway.test]
...
output "tags_any_filter_is_useful" {
  value = length(data.sbercloud_dc_resources_by_tags.tags_any_filter.resources) > 0
}

data "sbercloud_dc_resources_by_tags" "not_tags_any_filter" {
  depends_on = [sbercloud_dc_virtual_gateway.test]
...
output "not_tags_any_filter_is_useful" {
  value = length(data.sbercloud_dc_resources_by_tags.not_tags_any_filter.resources) > 0
}

data "sbercloud_dc_resources_by_tags" "total_count_test" {
  depends_on = [sbercloud_dc_virtual_gateway.test]
