...
func TestAccVirtualInterfaceSwitchover_basic(t *testing.T) {
	...
	rName := "sbercloud_dc_virtual_interface_switchover.test"
	updateResourceName := "sbercloud_dc_virtual_interface_switchover.update"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "resource_id",
						"sbercloud_dc_virtual_interface.test", "id"),
...
resource "sbercloud_dc_virtual_interface_switchover" "test" {
  resource_id   = sbercloud_dc_virtual_interface.test.id
  operation     = "shutdown"
...
resource "sbercloud_dc_virtual_interface_switchover" "update" {
  resource_id   = sbercloud_dc_virtual_interface.test.id
