...
`, testAccEvsVolume_postPaidWithServer_base(name), name, acceptance.SBC_ENTERPRISE_PROJECT_ID_TEST)
}
...
// This test case is used to test the `SSD` type cloud hard disk, which can be used in cn-north-4.
...
`, testAccEvsVolume_prePaidWithServer_base(name), name, acceptance.SBC_ENTERPRISE_PROJECT_ID_TEST)
}
