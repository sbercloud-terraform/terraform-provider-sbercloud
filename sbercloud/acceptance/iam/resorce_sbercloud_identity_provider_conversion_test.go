...
func TestAccIdentityProviderConversion_basic(t *testing.T) {
	...
	resourceName := "sbercloud_identity_provider_conversion.conversion"
...
resource "sbercloud_identity_provider_conversion" "conversion" {
  provider_id = sbercloud_identity_provider.provider_1.id
