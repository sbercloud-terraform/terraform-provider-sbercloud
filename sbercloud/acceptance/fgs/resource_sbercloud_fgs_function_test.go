...
func getFunction(cfg *config.Config, state *terraform.ResourceState) (interface{}, error) {
	client, err := cfg.NewServiceClient("fgs", acceptance.SBC_REGION_NAME)
	if err != nil {
...
//					resource.TestCheckResourceAttr(withObsStorage, "agency", acceptance.SBC_FGS_AGENCY_NAME),
...
//					resource.TestCheckResourceAttr(withCustomImage, "agency", acceptance.SBC_FGS_AGENCY_NAME),
...
//					resource.TestCheckResourceAttr(withCustomImage, "custom_image.0.url", acceptance.SBC_BUILD_IMAGE_URL),
...
//					resource.TestCheckResourceAttr(withDeprecatedParams, "xrole", acceptance.SBC_FGS_AGENCY_NAME),
//				),
//			},
//			{
...
//					resource.TestCheckResourceAttr(withCustomImage, "app", "default"),
//					resource.TestCheckResourceAttr(withCustomImage, "app_agency", acceptance.SBC_FGS_APP_AGENCY_NAME),
//					resource.TestCheckResourceAttr(withCustomImage, "handler", "-"),
...
//					resource.TestCheckResourceAttr(withCustomImage, "custom_image.#", "1"),
//					resource.TestCheckResourceAttr(withCustomImage, "custom_image.0.url", acceptance.SBC_BUILD_IMAGE_URL_UPDATED),
...
//		acceptance.SBC_FGS_DEPENDENCY_OBS_LINK)
//}
//
...
//		acceptance.SBC_FGS_AGENCY_NAME,
//		acceptance.SBC_BUILD_IMAGE_URL)
//}
//
...
//`, zipFileUploadResourcesConfig(name, runtime), name, runtime,
//		acceptance.SBC_FGS_AGENCY_NAME,
//		acceptance.SBC_FGS_APP_AGENCY_NAME,
//		acceptance.SBC_BUILD_IMAGE_URL_UPDATED)
//}
//
...
//			},
//			{
//				Config: testAccFunction_withEpsId(name, acceptance.SBC_ENTERPRISE_PROJECT_ID_TEST),
//				Check: resource.ComposeTestCheckFunc(
//					rc.CheckResourceExists(),
...
//  enable_lts_log        = true
//}
//`, testAccFunction_logConfig_base(name), name, acceptance.SBC_FGS_AGENCY_NAME)
//}
//
...
//					resource.TestCheckResourceAttr(createWithNetwork, "agency", acceptance.SBC_FGS_AGENCY_NAME),
...
//					resource.TestCheckResourceAttrSet(createWithNetwork, "peering_cidr"),
//					rcCreateWithoutNetwork.CheckResourceExists(),
//					resource.TestCheckResourceAttr(createWithoutNetwork, "agency", acceptance.SBC_FGS_AGENCY_NAME),
...
//  description = "Created by terraform script"
//}
//`, testAccFunction_network_base(name), name, acceptance.SBC_FGS_AGENCY_NAME)
//}
//
...
//					resource.TestCheckResourceAttr(resourceName, "gpu_type", acceptance.SBC_FGS_GPU_TYPE),
//				),
//			},
//			{
...
//  gpu_type    = "%[4]s"
//}
//`, functionScriptVariableDefinition, name, memory, acceptance.SBC_FGS_GPU_TYPE)
//}
//
