...
func TestAccDependencyVersion_basic(t *testing.T) {
	var (
		...
		resourceName = "sbercloud_fgs_dependency_version.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "link", acceptance.SBC_FGS_DEPENDENCY_OBS_LINK),
...
`, rName, acceptance.SBC_FGS_DEPENDENCY_OBS_LINK)
}
