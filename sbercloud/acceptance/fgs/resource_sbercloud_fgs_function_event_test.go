...
func TestAccFunctionEvent_basic(t *testing.T) {
	var (
		...
		resourceName    = "sbercloud_fgs_function_event.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "function_urn", "sbercloud_fgs_function.test", "urn"),
...
`, name, acceptance.SBC_FGS_AGENCY_NAME, funcCode)
}
