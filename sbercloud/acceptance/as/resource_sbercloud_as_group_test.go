...
func TestAccASGroup_basic(t *testing.T) {
	var (
		...
		resourceName = "sbercloud_as_group.acc_as_group"
	)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "lbaas_listeners.0.protocol_port",
						"sbercloud_lb_listener.listener_1", "protocol_port"),
...
`, testASGroup_Base(rName), rName, acceptance.SBC_ENTERPRISE_PROJECT_ID_TEST)
}
