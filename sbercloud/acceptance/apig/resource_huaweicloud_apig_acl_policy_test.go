...
func TestAccAclPolicy_basic(t *testing.T) {
	var (
		...
		rName1 = "sbercloud_apig_acl_policy.ip_rule"
		rName2 = "sbercloud_apig_acl_policy.domain_rule"
		rName3 = "sbercloud_apig_acl_policy.domain_id_rule"
...
resource "sbercloud_apig_acl_policy" "ip_rule" {
...
resource "sbercloud_apig_acl_policy" "domain_rule" {
  instance_id = local.instance_id
...
resource "sbercloud_apig_acl_policy" "domain_id_rule" {
  instance_id = local.instance_id
