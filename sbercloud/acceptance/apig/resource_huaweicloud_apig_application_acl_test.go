...
func TestAccApplicationAcl_basic(t *testing.T) {
	var (
		...
		rName      = "sbercloud_apig_application_acl.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "instance_id", "data.sbercloud_apig_instances.test", "instances.0.id"),
					resource.TestCheckResourceAttrPair(rName, "application_id", "sbercloud_apig_application.test", "id"),
...
resource "sbercloud_apig_application_acl" "test" {
  instance_id    = local.instance_id
