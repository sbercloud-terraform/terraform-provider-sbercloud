...
func TestAccResourceAppQuota_basic(t *testing.T) {
	var (
		obj          interface{}
		resourceName = "sbercloud_apig_application_quota.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "instance_id", "data.sbercloud_apig_instances.test", "instances.0.id"),
