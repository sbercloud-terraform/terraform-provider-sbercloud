...
func TestAccInstanceRoutes_basic(t *testing.T) {
	var (
		...
		rName = "sbercloud_apig_instance_routes.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "instance_id", "sbercloud_apig_instance.test", "id"),
...
resource "sbercloud_apig_instance_routes" "test" {
