...
func TestAccCssConfiguration_basic(t *testing.T) {
	...
	rName := "sbercloud_css_configuration.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "cluster_id", "sbercloud_css_cluster.test", "id"),
...
resource "sbercloud_css_configuration" "test" {
  cluster_id                   = sbercloud_css_cluster.test.id
