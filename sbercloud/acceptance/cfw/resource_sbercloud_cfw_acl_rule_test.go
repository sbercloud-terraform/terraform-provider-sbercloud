...
//	rName := "sbercloud_cfw_acl_rule.r1"
//
...
//
//	name := acceptance.RandomAccResourceName()
//	rName := "sbercloud_cfw_acl_rule.test"
//
//	rc := acceptance.InitResourceCheck(
//		rName,
//		&obj,
...
//					resource.TestCheckResourceAttr(rName, "destination_addresses.0", "1.1.1.2"),
//					resource.TestCheckResourceAttrPair(rName, "custom_service_groups.0.group_ids.0", "sbercloud_cfw_service_group.s1", "id"),
...
//					resource.TestCheckResourceAttrPair(rName, "custom_service_groups.0.group_ids.0", "sbercloud_cfw_service_group.s2", "id"),
//					resource.TestCheckResourceAttrPair(rName, "custom_service_groups.0.group_ids.1", "sbercloud_cfw_service_group.s3", "id"),
//					resource.TestCheckResourceAttr(rName, "custom_service_groups.0.protocols.0", "6"),
//					resource.TestCheckResourceAttr(rName, "tags.k1", "v1"),
//				),
//			},
...
//					resource.TestCheckResourceAttr(rName, "source_addresses.#", "1"),
//					resource.TestCheckResourceAttr(rName, "source_addresses.0", "1.1.1.2"),
//					resource.TestCheckResourceAttrPair(rName, "destination_domain_group_id", "sbercloud_cfw_domain_name_group.dg1", "id"),
//					resource.TestCheckResourceAttrPair(rName, "destination_domain_group_name", "sbercloud_cfw_domain_name_group.dg1", "name"),
...
//					resource.TestCheckResourceAttr(rName, "source_addresses.#", "1"),
//					resource.TestCheckResourceAttr(rName, "source_addresses.0", "1.1.1.2"),
//					resource.TestCheckResourceAttrPair(rName, "destination_domain_group_id", "sbercloud_cfw_domain_name_group.dg2", "id"),
//					resource.TestCheckResourceAttrPair(rName, "destination_domain_group_name", "sbercloud_cfw_domain_name_group.dg2", "name"),
//					resource.TestCheckResourceAttr(rName, "destination_domain_group_type", "4"),
//				),
//			},
//			{
...
//					resource.TestCheckResourceAttrPair(rName, "source_address_groups.0", "sbercloud_cfw_address_group.g1", "id"),
//					resource.TestCheckResourceAttrPair(rName, "source_address_groups.1", "sbercloud_cfw_address_group.g2", "id"),
...
//					resource.TestCheckResourceAttrPair(rName, "destination_address_groups.0", "sbercloud_cfw_address_group.g1", "id"),
//					resource.TestCheckResourceAttrPair(rName, "destination_address_groups.1", "sbercloud_cfw_address_group.g2", "id"),
//					resource.TestCheckResourceAttr(rName, "custom_services.0.protocol", "6"),
//					resource.TestCheckResourceAttr(rName, "custom_services.0.source_port", "80"),
//					resource.TestCheckResourceAttr(rName, "custom_services.0.dest_port", "80"),
//				),
...
//%[1]s
//
//resource "sbercloud_cfw_acl_rule" "r1" {
//  name                = "%[2]s"
...
//
//  depends_on = [
//    sbercloud_cfw_acl_rule.r2,
//  ]
//}
//
//resource "sbercloud_cfw_acl_rule" "r2" {
//  name                = "%[2]s2"
//  object_id           = data.sbercloud_cfw_firewalls.test.records[0].protect_objects[0].object_id
//  description         = "terraform test"
//  type                = 0
...
//  sequence {
//    top          = 0
//    dest_rule_id = sbercloud_cfw_acl_rule.r2.id
//  }
//
//  tags = {
//    k1 = "v1"
...
//    protocols = [6]
//    group_ids = [
//      sbercloud_cfw_service_group.s1.id,
//    ]
//  }
//
...
//    protocols = [6]
//    group_ids = [
//      sbercloud_cfw_service_group.s2.id,
//      sbercloud_cfw_service_group.s3.id,
//    ]
//  }
//
//  predefined_service_groups {
...
//
//  source_addresses              = ["1.1.1.2"]
//  destination_domain_group_id   = sbercloud_cfw_domain_name_group.dg1.id
//  destination_domain_group_name = sbercloud_cfw_domain_name_group.dg1.name
...
//
//  source_addresses              = ["1.1.1.2"]
//  destination_domain_group_id   = sbercloud_cfw_domain_name_group.dg2.id
//  destination_domain_group_name = sbercloud_cfw_domain_name_group.dg2.name
//  destination_domain_group_type = 4
//
//  custom_services {
//    protocol    = 6
...
//    sbercloud_cfw_address_group.g1.id,
//    sbercloud_cfw_address_group.g2.id,
//  ]
//
...
//	return fmt.Sprintf(`
//resource "sbercloud_cfw_address_group" "g1" {
//  object_id   = data.sbercloud_cfw_firewalls.test.records[0].protect_objects[0].object_id
//  name        = "%[1]s_ag1"
//  description = "address group 1"
//}
//
//resource "sbercloud_cfw_address_group" "g2" {
//  object_id   = data.sbercloud_cfw_firewalls.test.records[0].protect_objects[0].object_id
//  name        = "%[1]s_ag2"
//  description = "address group 2"
//}
//
//resource "sbercloud_cfw_address_group" "g3" {
//  object_id   = data.sbercloud_cfw_firewalls.test.records[0].protect_objects[0].object_id
//  name        = "%[1]s_ag3"
//  description = "address group 3"
//}
//
//resource "sbercloud_cfw_service_group" "s1" {
//  object_id   = data.sbercloud_cfw_firewalls.test.records[0].protect_objects[0].object_id
//  name        = "%[1]s_sg1"
//  description = "service group 1"
//}
//
//resource "sbercloud_cfw_service_group" "s2" {
//  object_id   = data.sbercloud_cfw_firewalls.test.records[0].protect_objects[0].object_id
//  name        = "%[1]s_sg2"
//  description = "service group 2"
//}
//
//resource "sbercloud_cfw_service_group" "s3" {
//  object_id   = data.sbercloud_cfw_firewalls.test.records[0].protect_objects[0].object_id
//  name        = "%[1]s_sg3"
//  description = "service group 3"
//}
//
//resource "sbercloud_cfw_service_group_member" "m1" {
//  group_id    = sbercloud_cfw_service_group.s1.id
//  protocol    = 6
//  source_port = "80"
//  dest_port   = "22"
//}
//
//resource "sbercloud_cfw_service_group_member" "m2" {
//  group_id    = sbercloud_cfw_service_group.s2.id
//  protocol    = 6
//  source_port = "81"
//  dest_port   = "23"
//}
//
//resource "sbercloud_cfw_service_group_member" "m3" {
//  group_id    = sbercloud_cfw_service_group.s3.id
//  protocol    = 6
//  source_port = "82"
//  dest_port   = "24"
//}
//
//resource "sbercloud_cfw_domain_name_group" "dg1" {
//  fw_instance_id = data.sbercloud_cfw_firewalls.test.records[0].fw_instance_id
//  object_id      = data.sbercloud_cfw_firewalls.test.records[0].protect_objects[0].object_id
//  name           = "%[1]s_dg1"
//  type           = 0
...
//}
//
//resource "sbercloud_cfw_domain_name_group" "dg2" {
//  fw_instance_id = data.sbercloud_cfw_firewalls.test.records[0].fw_instance_id
//  object_id      = data.sbercloud_cfw_firewalls.test.records[0].protect_objects[0].object_id
//  name           = "%[1]s_dg2"
//  type           = 0
