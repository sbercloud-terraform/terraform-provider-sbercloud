...
//	dataSource := "data.sbercloud_cfw_attack_logs.test"
...
//	return fmt.Sprintf(`
//data "sbercloud_cfw_attack_logs" "test" {
//  fw_instance_id = "%[1]s"
//  start_time     = "%[2]s"
//  end_time       = "%[3]s"
//}
...
//
//locals {
//  records           = data.sbercloud_cfw_attack_logs.test.records
...
//}
//
//data "sbercloud_cfw_attack_logs" "filter_by_src_region_name" {
//  fw_instance_id  = "%[1]s"
//  start_time      = "%[2]s"
//  end_time        = "%[3]s"
...
//}
//
//data "sbercloud_cfw_attack_logs" "filter_by_dst_region_name" {
//  fw_instance_id  = "%[1]s"
//  start_time      = "%[2]s"
//  end_time        = "%[3]s"
...
//}
//
//data "sbercloud_cfw_attack_logs" "filter_by_src_province_name" {
//  fw_instance_id    = "%[1]s"
//  start_time        = "%[2]s"
//  end_time          = "%[3]s"
...
//}
//
//data "sbercloud_cfw_attack_logs" "filter_by_dst_province_name" {
//  fw_instance_id    = "%[1]s"
//  start_time        = "%[2]s"
//  end_time          = "%[3]s"
...
//
//locals {
//  records_by_src_region_name   = data.sbercloud_cfw_attack_logs.filter_by_src_region_name.records
//  records_by_dst_region_name   = data.sbercloud_cfw_attack_logs.filter_by_dst_region_name.records
//  records_by_src_province_name = data.sbercloud_cfw_attack_logs.filter_by_src_province_name.records
//  records_by_dst_province_name = data.sbercloud_cfw_attack_logs.filter_by_dst_province_name.records
//}
//
...
//  )
//}
//`, acceptance.SBC_CFW_INSTANCE_ID, acceptance.SBC_CFW_START_TIME, acceptance.SBC_CFW_END_TIME)
//}
