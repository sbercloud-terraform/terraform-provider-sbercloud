...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_as_policy_execute_logs"
description: |
  Use this data source to get a list of AS policy execution logs within SberCloud.
---

# sbercloud_as_policy_execute_logs
