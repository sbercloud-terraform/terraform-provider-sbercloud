...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_as_notification"
description: ""
---

# sbercloud_as_notification

Manages an AS notification resource within SberCloud.
...
resource "sbercloud_as_notification" "test" {
...
```shell
$ terraform import sbercloud_as_notification.test <scaling_group_id>/<topic_urn>
```
