...
resource "sbercloud_vpc_route_table" "demo" {
  name        = "demo"
  vpc_id      = var.vpc_id
...
resource "sbercloud_vpc_route_table" "demo" {
  name    = "demo"
  vpc_id  = var.vpc_id
  subnets = data.sbercloud_vpc_subnet_ids.subnet_ids.ids
...
```
$ terraform import sbercloud_vpc_route_table.demo e1b3208a-544b-42a7-84e6-5d70371dd982
```
