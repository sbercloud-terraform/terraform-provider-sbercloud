...
```hcl
resource "sbercloud_lts_group" "test_group" {
  group_name  = "test_group"
  ttl_in_days = 1
}
resource "sbercloud_lts_stream" "test_stream" {
  group_id    = sbercloud_lts_group.test_group.id
...
```
$ terraform import sbercloud_lts_stream.stream_1 393f2bfd-2244-11ea-adb7-286ed488c87f/72855918-20b1-11ea-80e0-286ed488c880
```
