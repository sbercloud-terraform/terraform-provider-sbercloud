...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_dds_parameter_template"
description: ""
---
...
resource "sbercloud_dds_parameter_template" "test"{
  name             = var.name
...
```bash
$ terraform import sbercloud_dds_parameter_template.test <tempalate_id>
```
