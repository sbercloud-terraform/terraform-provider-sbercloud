...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_dc_hosted_connect"
description: ""
---

# sbercloud_dc_hosted_connect

Manages a hosted connection resource within SberCloud.
...
```bash
$ terraform import sbercloud_dc_hosted_connect.test ac0fe389-02f5-4463-9647-58bbb3d21fed
```
