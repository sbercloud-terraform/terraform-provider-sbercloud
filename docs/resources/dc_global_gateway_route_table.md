...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_dc_global_gateway_route_table"
description: |-
  Manages a DC global gateway route table resource within SberCloud.
---

# sbercloud_dc_global_gateway_route_table
...
```bash
$ terraform import sbercloud_dc_global_gateway_route_table.test <gdgw_id>/<id>
```
