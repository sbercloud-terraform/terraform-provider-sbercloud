...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_apig_api_batch_action"
description: |-
   Use this resource to batch operate APIs within SberCloud.
---

# sbercloud_apig_api_batch_action
...
resource "sbercloud_apig_api_batch_action" "publish" {
...
resource "sbercloud_apig_api_batch_action" "unpublish" {
  instance_id = var.instance_id
  action      = "offline"
  env_id      = var.env_id
  apis        = var.api_ids
...
resource "sbercloud_apig_api_batch_action" "publish_group" {
  instance_id = var.instance_id
  action      = "online"
  env_id      = var.env_id
