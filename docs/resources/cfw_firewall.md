...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_cfw_firewall"
description: ""
---

# sbercloud_cfw_firewall
...
resource "sbercloud_cfw_firewall" "test" {
  ...
  east_west_firewall_er_id           = sbercloud_er_instance.test.id
...
```bash
$ terraform import sbercloud_cfw_firewall.test 6cb1ce47-9990-447e-b071-d167c5393871
```
