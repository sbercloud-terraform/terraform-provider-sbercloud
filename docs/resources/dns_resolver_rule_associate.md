...
layout: "sbercloud"
page_title: "sberCloud: sbercloud_dns_resolver_rule_associate"
description: |-
  Manages a DNS resolver rule associate resource within sberCloud.
---

# sbercloud_dns_resolver_rule_associate
...
```bash
$ terraform import sbercloud_dns_resolver_rule_associate.test <id>
```
