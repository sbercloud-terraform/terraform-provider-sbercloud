...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_cce_cluster_log_config"
description: |-
  Use this resource to manage the log config of a CCE cluster within Sberloud.
---

# sbercloud_cce_cluster_log_config

Use this resource to manage the log config of a CCE cluster within SberCloud.
...
resource "sbercloud_cce_cluster_log_config" "test" {
...
```bash
$ terraform import sbercloud_cce_cluster_log_config.test <cluster_id>
```
