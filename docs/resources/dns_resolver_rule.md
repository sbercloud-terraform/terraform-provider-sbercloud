...
layout: "sbercloud"
page_title: "sberCloud: sbercloud_dns_resolver_rule"
description: |-
  Manages a DNS resolver rule resource within sberCloud.
---

# sbercloud_dns_resolver_rule
...
```bash
$ terraform import sbercloud_dns_resolver_rule.test <id>
```
