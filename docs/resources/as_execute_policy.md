...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_as_execute_policy"
description: |-
  Manages an AS execute policy resource within SberCloud.
---

# sbercloud_as_execute_policy
...
<br/>4. After creating the resource, you can use the datasource `sbercloud_as_policy_execute_logs` to querry
