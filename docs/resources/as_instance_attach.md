...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_as_instance_attach"
description: ""
---

# sbercloud_as_instance_attach

Manages an AS instance attachment resource within SberCloud.
...
resource "sbercloud_as_instance_attach" "test" {
...
```shell
$ terraform import sbercloud_as_instance_attach.test <scaling_group_id>/<instance_id>
```
