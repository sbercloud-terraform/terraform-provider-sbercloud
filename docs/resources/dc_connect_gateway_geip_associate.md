...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_dc_connect_gateway_geip_associate"
description: |-
  Manages a DC connect gateway resource within SberCloud.
---

# sbercloud_dc_connect_gateway_geip_associate
...
resource "sbercloud_dc_connect_gateway_geip_associate" "test" {
...
```bash
$ terraform import sbercloud_dc_connect_gateway_geip_associate.test <connect_gateway_id>/<global_eip_id>
```
