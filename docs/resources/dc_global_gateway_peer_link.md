...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_dc_global_gateway_peer_link"
description: |-
  Manages a DC global gateway peer link resource within SberCloud.
---

# sbercloud_dc_global_gateway_peer_link
...
resource "sbercloud_dc_global_gateway_peer_link" "test" {
  name                 = var.name
...
```bash
$ terraform import sbercloud_dc_global_gateway_peer_link.test <global_dc_gateway_id>/<id>
```
