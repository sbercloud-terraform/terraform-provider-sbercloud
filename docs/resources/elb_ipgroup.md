...
```hcl
resource "sbercloud_elb_ipgroup" "basic" {
  name        = "basic"
...
```
$ terraform import sbercloud_elb_ipgroup.group_1 5c20fdad-7288-11eb-b817-0255ac10158b
```
...
```
resource "sbercloud_elb_ipgroup" "group_1" {
    ...
  lifecycle {
    ignore_changes = [
