...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_fgs_trigger"
description: ""
---

# sbercloud_fgs_trigger

Manages a trigger resource within SberCloud FunctionGraph.  
It's recommend to use `sbercloud_fgs_function_trigger`, which makes a great improvement of managing function triggers.
...
* `schedule` - (Required, String, ForceNew) Specifies the time schedule.
  ...
  For the corn expression, please refer to the SberCloud
  [document](https://support.sbercloud.com/en-us/usermanual-functiongraph/functiongraph_01_0908.html).
  Changing this will create a new trigger resource.
