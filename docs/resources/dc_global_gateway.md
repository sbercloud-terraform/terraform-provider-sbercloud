...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_dc_global_gateway"
description: |-
  Manages a DC global gateway resource within SberCloud.
---

# sbercloud_dc_global_gateway
...
```bash
$ terraform import sbercloud_dc_global_gateway.test <id>
```
