...
resource "sbercloud_kms_key" mykey {
  key_alias    = "kms_sfs"
  pending_days = "7"
}
...
resource "sbercloud_sfs_file_system" "share-file" {
  ...
  metadata = {
    "#sfs_crypt_key_id"    = sbercloud_kms_key.mykey.id
    "#sfs_crypt_domain_id" = sbercloud_kms_key.mykey.domain_id
    "#sfs_crypt_alias"     = sbercloud_kms_key.mykey.key_alias
  }
  tags = {
    function = "encryption"
  }
...
-> **NOTE:** If you want to create more access rules, please using [sbercloud_sfs_access_rule](https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/latest/docs/resources/sfs_access_rule).
...
```
$ terraform import sbercloud_sfs_file_system 4779ab1c-7c1a-44b1-a02e-93dfc361b32d
```

**NOTE:** The `access_to`, `access_type` and `access_level` will not be imported.
Please importing them by [sbercloud_sfs_access_rule](https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/latest/docs/resources/sfs_access_rule).
