...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_cfw_domain_name_group"
description: |-
  Manages a CFW domain name group resource within SberCloud.
---

# sbercloud_cfw_domain_name_group
...
```bash
$ terraform import sbercloud_cfw_domain_name_group.test <fw_instance_id>/<object_id>/<id>
```
