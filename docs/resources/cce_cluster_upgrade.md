...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_cce_cluster_upgrade"
description: |-
  Use this resource to upgrade a CCE cluster within SberCloud.
---

# sbercloud_cce_cluster_upgrade
  ...
  addons {
    ...
    values {
      basic_json = jsonencode({
        "cceEndpoint" : "https://cce.ru-moscow-1.sbercloud.ru",
        "ecsEndpoint" : "https://ecs.ru-moscow-1.sbercloud.ru",
        "image_version" : "1.29.17",
        "region" : "cn-north-4",
        "swr_addr" : "swr.ru-moscow-1.sbercloud.ru",
        "swr_user" : "hwofficial"
      })
