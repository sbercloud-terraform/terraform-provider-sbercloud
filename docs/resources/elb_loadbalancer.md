...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_elb_loadbalancer"
description: |-
...
resource "sbercloud_elb_loadbalancer" "basic" {
  name              = "basic"
...
* `charging_mode` - (Optional, String) Specifies the charging mode of the ELB load balancer.
  Support only **postPaid** value, defaults to **postPaid**.
...
```bash
$ terraform import sbercloud_elb_loadbalancer.loadbalancer_1 <id>
```
