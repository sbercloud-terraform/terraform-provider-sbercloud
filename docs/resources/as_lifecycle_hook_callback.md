...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_as_lifecycle_hook_callback"
description: |-
  Manages an AS lifecycle hook callback resource within SberCloud.
---

# sbercloud_as_lifecycle_hook_callback
