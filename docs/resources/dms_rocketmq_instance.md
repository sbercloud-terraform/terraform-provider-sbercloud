...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_dms_rocketmq_instance"
description: ""
---

# sbercloud_dms_rocketmq_instance
...
```bash
$ terraform import sbercloud_dms_rocketmq_instance.test 8d3c7938-dc47-4937-a30f-c80de381c5e3
```
