...
layout: "sbercloud"
page_title: "SberCloud: sbercloud_apig_api_check"
description: |-
  Use this resource to check whether the API name or path already exists within SberCloud.
---

# sbercloud_apig_api_check
